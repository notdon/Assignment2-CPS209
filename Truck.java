...
public class Truck extends Vehicle {
	...
	public void draw(Graphics2D g2)
	{
		...
		Rectangle2D.Double body = new Rectangle2D.Double(x1 + U3,y1,U10, U4) ; //draws the body 
		g2.setColor(Color.blue) ;
		g2.fill(body) ;


		Ellipse2D.Double wheel1 = new Ellipse2D.Double(x1 + U_3, y1 + U4, UNIT, UNIT) ; //draws the wheel
		g2.setColor(Color.black) ;
		g2.fill(wheel1) ;

		Ellipse2D.Double wheel2 = new Ellipse2D.Double(x1 + U3, y1 + U4, UNIT, UNIT) ; //draws the wheel2
		g2.setColor(Color.black) ;
		g2.fill(wheel2) ;

		Ellipse2D.Double wheel3 = new Ellipse2D.Double(x1 + 4 * UNIT, y1 + 4 * UNIT, UNIT, UNIT) ; //draws the wheel3
		g2.setColor(Color.black) ;
		g2.fill(wheel3) ;

		Ellipse2D.Double wheel4 = new Ellipse2D.Double(x1 + U10_7, y1 + U4, UNIT, UNIT) ; //draws the wheel4
		g2.setColor(Color.black) ;
		g2.fill(wheel4) ;

		Ellipse2D.Double wheel5 = new Ellipse2D.Double(x1 + U12, y1 + U4, UNIT, UNIT) ; //draws the wheel5
		g2.setColor(Color.black) ;
		g2.fill(wheel5) ;
